            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="home-theme-panel home-hero-shell rounded-xl p-6 sm:p-8 relative overflow-hidden">
                    ...
                    <p className="home-theme-subtitle mb-8 relative z-10">
                        Write and publish your story with a polished editorial
                        look.
                    </p>
                            ...
                            {imagePreview ? (
                                <div className="relative">
                                    ...
                                    <button
                                        type="button"
                                        onClick={removeImage}
                                        className="absolute top-2 right-2 p-2 bg-[#b94747] text-white rounded-full hover:bg-[#983737] transition-colors border border-[#8f2d2d]"
                                    >
                                        <FiX />
                                    </button>
                                </div>
